class EnvironmentConfig {
  ...
  static const String CONFIG_DETAIL_PAGE_CREDITS_VIEW = String.fromEnvironment(
    "CONFIG_DETAIL_PAGE_CREDITS_VIEW",
    defaultValue: "MOVIE_CREDITS_VIEW_GALAXY_APP",
  );

  static const String CONFIG_PAYMENT_CARD_VIEW = String.fromEnvironment(
    "CONFIG_PAYMENT_CARDS_VIEW",
    defaultValue: "PAYMENT_CARDS_VIEW_GALAXY_APP",
  );
}
